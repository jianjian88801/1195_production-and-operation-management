    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业编号" prop="zuoyebianhao">
          <el-input v-model="ruleForm.zuoyebianhao" 
              placeholder="作业编号" clearable  :readonly="ro.zuoyebianhao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业内容" prop="zuoyeneirong">
          <el-input v-model="ruleForm.zuoyeneirong" 
              placeholder="作业内容" clearable  :readonly="ro.zuoyeneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作业内容" prop="zuoyeneirong">
              <el-input v-model="ruleForm.zuoyeneirong" 
                placeholder="作业内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="内容标题" prop="neirongbiaoti">
          <el-input v-model="ruleForm.neirongbiaoti" 
              placeholder="内容标题" clearable  :readonly="ro.neirongbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="内容标题" prop="neirongbiaoti">
              <el-input v-model="ruleForm.neirongbiaoti" 
                placeholder="内容标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="提交作业" prop="tijiaozuoye">
          <file-upload
          tip="点击上传提交作业"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.tijiaozuoye?ruleForm.tijiaozuoye:''"
          @change="tijiaozuoyeUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.tijiaozuoye" label="提交作业" prop="tijiaozuoye">
            <el-button type="text" size="small" @click="download(ruleForm.tijiaozuoye)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='neirongbiaoti'){
            this.ruleForm.neirongbiaoti = obj[o];
	    this.ro.neirongbiaoti = true;
            continue;
          }
	    ...
	    this.ro.wanchengneirong = true;
          ...
          if(o=='tijiaozuoye'){
            this.ruleForm.tijiaozuoye = obj[o];
	    this.ro.tijiaozuoye = true;
            continue;
          }
          if(o=='tijiaoriqi'){
    ...
    tijiaozuoyeUploadChange(fileUrls) {
	this.ruleForm.tijiaozuoye = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
