  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">作业管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yuanxi" class="input" type="text" placeholder="院系">
			   </div>
			 </div> -->
			<el-form-item label="院系" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.yuanxi" autocomplete="off" placeholder="院系"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210105/f9b2ecc8bc354841a514b34541700e8e.jpg");
		height: 100vh;
